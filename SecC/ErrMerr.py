...
def getArgs():
    ...
    error_3d_parser = subparsers.add_parser('3D', help=None)
    error_3d_parser.add_argument("mdBam",
                                 help="bam generated by Samtools calmd"
                                      "command")
    error_3d_parser.add_argument("-cycleheat", default=False, action='store_true')
    error_3d_parser.add_argument("--minFM", default=1, type=int)
    error_3d_parser.add_argument("--maxFM", default=1000, type=int)
    error_3d_parser.add_argument("--pickle-path", type=str)
    error_3d_parser.add_argument("--table-prefix", type=str)
