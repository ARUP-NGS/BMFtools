/*
 * error.h -- declaration for error-reporting function Copyright (C) 1995,
 ...
 * by gcc versions 2.6.4 (effectively 2.7) and later.
 */
 ...
 * nonzero, follow it with ": " and strerror (ERRNUM). If STATUS is nonzero,
