...
/*
 * Define if on AIX 3. System headers sometimes define this. We just want to
 * avoid a redefinition error message.
 */
#ifndef _ALL_SOURCE
/* #undef _ALL_SOURCE */
#endif
 ...
 * deduced at run-time. STACK_DIRECTION > 0 => grows toward higher addresses
 * STACK_DIRECTION < 0 => grows toward lower addresses STACK_DIRECTION = 0 =>
