...
#define __PYX_HAVE__MawCluster__SplitMarkFastq
#define __PYX_HAVE_API__MawCluster__SplitMarkFastq
#include "stdint.h"
#include "string.h"
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from 'MawCluster.SplitMarkFastq' */
#define __Pyx_MODULE_NAME "MawCluster.SplitMarkFastq"
int __pyx_module_is_main_MawCluster__SplitMarkFastq = 0;

/* Implementation of 'MawCluster.SplitMarkFastq' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initSplitMarkFastq(void); /*proto*/
PyMODINIT_FUNC initSplitMarkFastq(void)
#else
PyMODINIT_FUNC PyInit_SplitMarkFastq(void); /*proto*/
PyMODINIT_FUNC PyInit_SplitMarkFastq(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_SplitMarkFastq(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("SplitMarkFastq", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_MawCluster__SplitMarkFastq) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "MawCluster.SplitMarkFastq")) {
      if (unlikely(PyDict_SetItemString(modules, "MawCluster.SplitMarkFastq", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "MawCluster/SplitMarkFastq.pyx":1
             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init MawCluster.SplitMarkFastq", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init MawCluster.SplitMarkFastq");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
