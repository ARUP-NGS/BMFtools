...
#endif
#include <math.h>
#define __PYX_HAVE__utilBMF__cFqProc
#define __PYX_HAVE_API__utilBMF__cFqProc
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'utilBMF.cFqProc' */
#define __Pyx_MODULE_NAME "utilBMF.cFqProc"
int __pyx_module_is_main_utilBMF__cFqProc = 0;

/* Implementation of 'utilBMF.cFqProc' */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcFqProc(void); /*proto*/
PyMODINIT_FUNC initcFqProc(void)
#else
PyMODINIT_FUNC PyInit_cFqProc(void); /*proto*/
PyMODINIT_FUNC PyInit_cFqProc(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cFqProc(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cFqProc", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_utilBMF__cFqProc) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "utilBMF.cFqProc")) {
      if (unlikely(PyDict_SetItemString(modules, "utilBMF.cFqProc", __pyx_m) < 0)) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init utilBMF.cFqProc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init utilBMF.cFqProc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
