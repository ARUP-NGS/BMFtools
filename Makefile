...
DB_FLAGS = -fno-inline -Wno-unused-function
PG_FLAGS = -Wno-unused-function -pg -DNDEBUG -O2 -fno-inline -DPUTC
UR_FLAGS = $(OPT_FLAGS) -DUNROLL

IGAMC_INC = include/igamc_cephes.c

BMF_SRC = src/bmf_main.c src/sam_opts.c src/crms.c include/igamc_cephes.c src/khash_dmp_core.c \
