...
def main():
    ...
    parser.add_argument("-n","--size-duplicate-family",help="Number of duplications in the duplicate family, one less than the number in the family",default=10)
    parser.add_argument("-i","--iterations",help="Number of Monte Carlo iterations.",default=100000)
    parser.add_argument("-r","--random",help="Randomly select the number of reads for a duplicate family",default=False)
    ...
    if(outfile == ""):
        outfile = "PCR_Duplication_Simulation_{}_InFamily_{}_Iterations.txt".format(size,args.iterations)
    countMC=0;
    sumHist=[0] * size
