...
# plot
        ...
        # borders
        ax.spines["top"].set_visible(False)#False
        ax.spines["right"].set_visible(False)#False
        ax.spines["bottom"].set_visible(False)#False
        ax.spines["left"].set_visible(False)#False
