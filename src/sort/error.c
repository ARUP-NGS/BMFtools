/*
 * error.c -- error handler for noninteractive utilities Copyright (C) 1990,
 * 91, 92, 93, 94, 95, 96 Free Software Foundation, Inc.
 * 
 ...
 * format string with optional args. If ERRNUM is nonzero, print its
 * corresponding system error message. Exit with status STATUS if it is
 * nonzero.
 */
/* VARARGS */
