...
subprocess.check_call('gcc src/dmp/fqmarksplit.c src/dmp/igamc_cephes.c -I src/dmp/ -I src/dmp/include -lm -lz -o src/dmp/fqmarksplit -fopenmp -std=gnu11 -finline-functions', shell=True)
...
subprocess.check_call('cd src/dmp && gcc -o vlcrms vlcrms.c -lz -lm -std=gnu11 -DNDEBUG -finline-functions -fopenmp -finline-functions -DNO_PARALLEL && cd ../..', shell=True)
...
config = {
    ...
    'scripts': ['utilBMF/bmftools', 'src/dmp/fqmarksplit', 'src/dmp/fqmarksplit_inline', 'src/sort/lh3sort',
                ...
                'src/dmp/bmf_bam_sort', 'src/dmp/vlcrms'],
    'name': 'BMFTools',
